...
class InfoBar :
    ...
    def draw_info(self):
        ...
        # Barre de mana
        mana_bar_rect = pygame.Rect(370, 12,self.mana_bar_length, 15)
        fond_mana = pygame.Rect(370, 11, 50, 17)

        pygame.draw.rect(self.screen, BLACK, fond_mana)
        pygame.draw.rect(self.screen, BLUE, mana_bar_rect)


        # Texte
        font = pygame.font.Font("assets/super_enjoy/Super Enjoy.ttf", 20)
